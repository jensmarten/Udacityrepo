...
"nc" Võimaldab teiste hostidega suhtlemise, 
seda kasutatakse tihti informatsiooni taotlustel ning andmete vahetamisel.
...
"dig" Töötab peaaegu samamoodi kui host käsk aga näitab ka detailsemat infot 
(Nt mis server täpsemalt sinu taotlusele vastas).
...
Ühendades ennast teise hostiga (nt veebilehega) läbi võrgu, peab sinu signaal
liikuma läbi mitme erineva IP aadressi (ruuteri), et jõuda hosti asukohta. 
Mida rohkem peatusi kust on vaja läbi minna, seda aeglasem on ühendus.
